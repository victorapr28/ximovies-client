...
gulp.task('dist', function(done) {
    ...
    //gulp.src('./../ximovies/public/client', {read: false}).pipe(clean({force: true}));
    rimraf.sync('./../ximovies/public/client');

    //copy dist folder into laravel public folder
    gulp.src(['./../dist/**/*', '!./../dist/index.html', '!./../dist/stats.json']).pipe(gulp.dest('./../ximovies/public/client'));
    ...
    const laravelViewPath = './../ximovies/resources/views/app.blade.php';
